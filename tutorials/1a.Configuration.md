By default, {@link Service} configuration is fetched from `$PROJECT_ROOT/config/config.js` by the service [execution procedure](https://github.com/BohemiaInteractive/bi-service/blob/master/bin/bi-service.js#L96).  
